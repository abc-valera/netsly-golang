...
The `infra` directory contains all the files needed to run the application properly.

The `infra/local` directory contains the local infrastructure generated by the application (databases, file uploads, logs, etc.).
