...
func (_m *Like) Create(ctx context.Context, req model.Like) (model.Like, error) {
...
func (_c *Like_Create_Call) Run(run func(ctx context.Context, req model.Like)) *Like_Create_Call {
...
func (_c *Like_Create_Call) RunAndReturn(run func(context.Context, model.Like) (model.Like, error)) *Like_Create_Call {
	_c.Call.Return(run)
	return _c
}
