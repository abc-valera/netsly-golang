...
func (_m *FileInfo) GetAll(ctx context.Context) (model.FileInfos, error) {
	ret := _m.Called(ctx)
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context) (model.FileInfos, error)); ok {
		return rf(ctx)
	}
	if rf, ok := ret.Get(0).(func(context.Context) model.FileInfos); ok {
		r0 = rf(ctx)
	} else {
		if ret.Get(0) != nil {
...
//   - ctx context.Context
func (_e *FileInfo_Expecter) GetAll(ctx interface{}) *FileInfo_GetAll_Call {
	return &FileInfo_GetAll_Call{Call: _e.mock.On("GetAll", ctx)}
}

func (_c *FileInfo_GetAll_Call) Run(run func(ctx context.Context)) *FileInfo_GetAll_Call {
...
func (_c *FileInfo_GetAll_Call) RunAndReturn(run func(context.Context) (model.FileInfos, error)) *FileInfo_GetAll_Call {
	_c.Call.Return(run)
	return _c
}
