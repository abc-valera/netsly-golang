...
type argonPassworder struct{}

func New() service.IPassworder {
	return &argonPassworder{}
}

func (pm argonPassworder) HashPassword(password string) (string, error) {
...
func (pm argonPassworder) CheckPassword(password, encodedHash string) error {
