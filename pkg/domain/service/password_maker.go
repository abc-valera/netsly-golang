...
import "github.com/abc-valera/netsly-api-golang/pkg/core/coderr"

var (
	ErrPasswordDontMatch = coderr.NewCodeMessage(coderr.CodeInvalidArgument, "Provided password doesn't match the original one")
)
