...
func (_m *Joke) GetAllByUserID(ctx context.Context, userID string, params selectParams.SelectParams) (model.Jokes, error) {
	...
	var r0 model.Jokes
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, selectParams.SelectParams) (model.Jokes, error)); ok {
		return rf(ctx, userID, params)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, selectParams.SelectParams) model.Jokes); ok {
...
func (_c *Joke_GetAllByUserID_Call) Run(run func(ctx context.Context, userID string, params selectParams.SelectParams)) *Joke_GetAllByUserID_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *Joke_GetAllByUserID_Call) RunAndReturn(run func(context.Context, string, selectParams.SelectParams) (model.Jokes, error)) *Joke_GetAllByUserID_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *Joke) SearchByTitle(ctx context.Context, keyword string, params selectParams.SelectParams) (model.Jokes, error) {
...
func (_c *Joke_SearchByTitle_Call) Run(run func(ctx context.Context, keyword string, params selectParams.SelectParams)) *Joke_SearchByTitle_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(string), args[2].(selectParams.SelectParams))
	})
	return _c
...
func (_c *Joke_SearchByTitle_Call) RunAndReturn(run func(context.Context, string, selectParams.SelectParams) (model.Jokes, error)) *Joke_SearchByTitle_Call {
	_c.Call.Return(run)
	return _c
}
