...
func (_m *User) SearchAllByUsername(ctx context.Context, keyword string, params selectParams.SelectParams) (model.Users, error) {
	...
	var r0 model.Users
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, selectParams.SelectParams) (model.Users, error)); ok {
		return rf(ctx, keyword, params)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, selectParams.SelectParams) model.Users); ok {
...
func (_c *User_SearchAllByUsername_Call) Run(run func(ctx context.Context, keyword string, params selectParams.SelectParams)) *User_SearchAllByUsername_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *User_SearchAllByUsername_Call) RunAndReturn(run func(context.Context, string, selectParams.SelectParams) (model.Users, error)) *User_SearchAllByUsername_Call {
	_c.Call.Return(run)
	return _c
}
