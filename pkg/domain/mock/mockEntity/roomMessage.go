...
// GetAllByRoomID provides a mock function with given fields: ctx, roomID, spec
func (_m *RoomMessage) GetAllByRoomID(ctx context.Context, roomID string, spec selectParams.SelectParams) (model.RoomMessages, error) {
	ret := _m.Called(ctx, roomID, spec)
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, selectParams.SelectParams) (model.RoomMessages, error)); ok {
		return rf(ctx, roomID, spec)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, selectParams.SelectParams) model.RoomMessages); ok {
		r0 = rf(ctx, roomID, spec)
	} else {
		if ret.Get(0) != nil {
...
//   - ctx context.Context
//   - roomID string
//   - spec selectParams.SelectParams
func (_e *RoomMessage_Expecter) GetAllByRoomID(ctx interface{}, roomID interface{}, spec interface{}) *RoomMessage_GetAllByRoomID_Call {
	return &RoomMessage_GetAllByRoomID_Call{Call: _e.mock.On("GetAllByRoomID", ctx, roomID, spec)}
}

func (_c *RoomMessage_GetAllByRoomID_Call) Run(run func(ctx context.Context, roomID string, spec selectParams.SelectParams)) *RoomMessage_GetAllByRoomID_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *RoomMessage_GetAllByRoomID_Call) RunAndReturn(run func(context.Context, string, selectParams.SelectParams) (model.RoomMessages, error)) *RoomMessage_GetAllByRoomID_Call {
	_c.Call.Return(run)
	return _c
}
...
// SearchAllByText provides a mock function with given fields: ctx, keyword, spec
func (_m *RoomMessage) SearchAllByText(ctx context.Context, keyword string, spec selectParams.SelectParams) (model.RoomMessages, error) {
	ret := _m.Called(ctx, keyword, spec)
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, selectParams.SelectParams) (model.RoomMessages, error)); ok {
		return rf(ctx, keyword, spec)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, selectParams.SelectParams) model.RoomMessages); ok {
		r0 = rf(ctx, keyword, spec)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(model.RoomMessages)
		}
...
//   - keyword string
//   - spec selectParams.SelectParams
func (_e *RoomMessage_Expecter) SearchAllByText(ctx interface{}, keyword interface{}, spec interface{}) *RoomMessage_SearchAllByText_Call {
	return &RoomMessage_SearchAllByText_Call{Call: _e.mock.On("SearchAllByText", ctx, keyword, spec)}
}

func (_c *RoomMessage_SearchAllByText_Call) Run(run func(ctx context.Context, keyword string, spec selectParams.SelectParams)) *RoomMessage_SearchAllByText_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(string), args[2].(selectParams.SelectParams))
	})
	return _c
...
func (_c *RoomMessage_SearchAllByText_Call) RunAndReturn(run func(context.Context, string, selectParams.SelectParams) (model.RoomMessages, error)) *RoomMessage_SearchAllByText_Call {
	_c.Call.Return(run)
	return _c
}
