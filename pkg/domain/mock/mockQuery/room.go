...
import (
	...
	spec "github.com/abc-valera/netsly-api-golang/pkg/domain/persistence/query/selectParams"
)
...
func (_m *Room) GetAllByUserID(ctx context.Context, userID string, params spec.SelectParams) (model.Rooms, error) {
...
func (_c *Room_GetAllByUserID_Call) Run(run func(ctx context.Context, userID string, params spec.SelectParams)) *Room_GetAllByUserID_Call {
...
func (_c *Room_GetAllByUserID_Call) RunAndReturn(run func(context.Context, string, spec.SelectParams) (model.Rooms, error)) *Room_GetAllByUserID_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *Room) SearchAllByName(ctx context.Context, keyword string, params spec.SelectParams) (model.Rooms, error) {
...
func (_c *Room_SearchAllByName_Call) Run(run func(ctx context.Context, keyword string, params spec.SelectParams)) *Room_SearchAllByName_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(string), args[2].(spec.SelectParams))
	})
	return _c
...
func (_c *Room_SearchAllByName_Call) RunAndReturn(run func(context.Context, string, spec.SelectParams) (model.Rooms, error)) *Room_SearchAllByName_Call {
	_c.Call.Return(run)
	return _c
}
