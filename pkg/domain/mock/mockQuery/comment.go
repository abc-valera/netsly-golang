...
func (_m *Comment) GetAllByJokeID(ctx context.Context, jokeID string, params selectParams.SelectParams) (model.Comments, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, selectParams.SelectParams) (model.Comments, error)); ok {
		return rf(ctx, jokeID, params)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, selectParams.SelectParams) model.Comments); ok {
...
func (_c *Comment_GetAllByJokeID_Call) Run(run func(ctx context.Context, jokeID string, params selectParams.SelectParams)) *Comment_GetAllByJokeID_Call {
...
func (_c *Comment_GetAllByJokeID_Call) RunAndReturn(run func(context.Context, string, selectParams.SelectParams) (model.Comments, error)) *Comment_GetAllByJokeID_Call {
	_c.Call.Return(run)
	return _c
}
