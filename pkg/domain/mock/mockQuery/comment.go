...
func (_m *Comment) GetAllByJokeID(ctx context.Context, jokeID string, params spec.SelectParams) (model.Comments, error) {
...
func (_c *Comment_GetAllByJokeID_Call) Run(run func(ctx context.Context, jokeID string, params spec.SelectParams)) *Comment_GetAllByJokeID_Call {
...
func (_c *Comment_GetAllByJokeID_Call) RunAndReturn(run func(context.Context, string, spec.SelectParams) (model.Comments, error)) *Comment_GetAllByJokeID_Call {
	_c.Call.Return(run)
	return _c
}
