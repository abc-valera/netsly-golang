...
func (_m *Joke) GetAllByUserID(ctx context.Context, userID string, params spec.SelectParams) (model.Jokes, error) {
...
func (_c *Joke_GetAllByUserID_Call) Run(run func(ctx context.Context, userID string, params spec.SelectParams)) *Joke_GetAllByUserID_Call {
...
func (_c *Joke_GetAllByUserID_Call) RunAndReturn(run func(context.Context, string, spec.SelectParams) (model.Jokes, error)) *Joke_GetAllByUserID_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *Joke) SearchByTitle(ctx context.Context, keyword string, params spec.SelectParams) (model.Jokes, error) {
...
func (_c *Joke_SearchByTitle_Call) Run(run func(ctx context.Context, keyword string, params spec.SelectParams)) *Joke_SearchByTitle_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(string), args[2].(spec.SelectParams))
	})
	return _c
...
func (_c *Joke_SearchByTitle_Call) RunAndReturn(run func(context.Context, string, spec.SelectParams) (model.Jokes, error)) *Joke_SearchByTitle_Call {
	_c.Call.Return(run)
	return _c
}
