...
var FileInfoTableColumns = struct {
	...
	DeletedAt: "file_infos.deleted_at",
}
...
var FileInfoWhere = struct {
	...
	Type:      whereHelperint64{field: "\"file_infos\".\"type\""},
	Size:      whereHelperint64{field: "\"file_infos\".\"size\""},
	CreatedAt: whereHelpertime_Time{field: "\"file_infos\".\"created_at\""},
	UpdatedAt: whereHelpertime_Time{field: "\"file_infos\".\"updated_at\""},
	DeletedAt: whereHelpertime_Time{field: "\"file_infos\".\"deleted_at\""},
}
...
var (
	fileInfoAllColumns            = []string{"id", "name", "type", "size", "created_at", "updated_at", "deleted_at"}
	fileInfoColumnsWithoutDefault = []string{"id", "name", "type", "size", "created_at", "updated_at", "deleted_at"}
...
func (q fileInfoQuery) One(ctx context.Context, exec boil.ContextExecutor) (*FileInfo, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "sqlboiler: failed to execute a one query for file_infos")
	}
...
func (q fileInfoQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "sqlboiler: failed to count file_infos rows")
	}
...
func (q fileInfoQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "sqlboiler: failed to check if file_infos exists")
	}
...
func FindFileInfo(ctx context.Context, exec boil.ContextExecutor, iD string, selectCols ...string) (*FileInfo, error) {
	...
	query := fmt.Sprintf(
		"select %s from \"file_infos\" where \"id\"=?", sel,
	)
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "sqlboiler: unable to select from file_infos")
	}
...
func (o *FileInfo) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("sqlboiler: no file_infos provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "sqlboiler: unable to insert into file_infos")
	}
...
func (o *FileInfo) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("sqlboiler: unable to update file_infos, could not build whitelist")
		}

		cache.query = fmt.Sprintf("UPDATE \"file_infos\" SET %s WHERE %s",
			strmangle.SetParamNames("\"", "\"", 0, wl),
			strmangle.WhereClause("\"", "\"", 0, fileInfoPrimaryKeyColumns),
		)
	...
	if err != nil {
		return 0, errors.Wrap(err, "sqlboiler: unable to update file_infos row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "sqlboiler: failed to get rows affected by update for file_infos")
	}
...
func (q fileInfoQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "sqlboiler: unable to update all for file_infos")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "sqlboiler: unable to retrieve rows affected for file_infos")
	}
...
func (o FileInfoSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	sql := fmt.Sprintf("UPDATE \"file_infos\" SET %s WHERE %s",
		...
		strmangle.WhereClauseRepeated(string(dialect.LQ), string(dialect.RQ), 0, fileInfoPrimaryKeyColumns, len(o)))
...
func (o *FileInfo) UpsertG(ctx context.Context, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
...
func (o *FileInfo) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("sqlboiler: no file_infos provided for upsert")
	}
	if !boil.TimestampsAreSkipped(ctx) {
		currTime := time.Now().In(boil.GetLocation())
	...
	if !cached {
		...
		if updateOnConflict && len(update) == 0 {
			return errors.New("sqlboiler: unable to upsert file_infos, could not build update column list")
		}
		...
		cache.query = buildUpsertQuerySQLite(dialect, "\"file_infos\"", updateOnConflict, ret, update, conflict, insert)
	...
	if err != nil {
		return errors.Wrap(err, "sqlboiler: unable to upsert file_infos")
	}
...
func (o *FileInfo) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM \"file_infos\" WHERE \"id\"=?"
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "sqlboiler: unable to delete from file_infos")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "sqlboiler: failed to get rows affected by delete for file_infos")
	}
...
func (q fileInfoQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "sqlboiler: unable to delete all from file_infos")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "sqlboiler: failed to get rows affected by deleteall for file_infos")
	}
...
func FileInfoExists(ctx context.Context, exec boil.ContextExecutor, iD string) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"file_infos\" where \"id\"=? limit 1)"
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "sqlboiler: unable to check if file_infos exists")
	}
