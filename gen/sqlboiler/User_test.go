...
func testUserToManyUserComments(t *testing.T) {
	var err error
	ctx := context.Background()
	tx := MustTx(boil.BeginTx(ctx, nil))
	defer func() { _ = tx.Rollback() }()
	...
	check, err := a.UserComments().All(ctx, tx)
	if err != nil {
		t.Fatal(err)
	}
	...
	slice := UserSlice{&a}
	if err = a.L.LoadUserComments(ctx, tx, false, (*[]*User)(&slice), nil); err != nil {
		t.Fatal(err)
	}
	if got := len(a.R.UserComments); got != 2 {
		t.Error("number of eager loaded records wrong, got:", got)
	}

	a.R.UserComments = nil
	if err = a.L.LoadUserComments(ctx, tx, true, &a, nil); err != nil {
		t.Fatal(err)
	}
	if got := len(a.R.UserComments); got != 2 {
		t.Error("number of eager loaded records wrong, got:", got)
...
func testUserToManyUserJokes(t *testing.T) {
	var err error
	ctx := context.Background()
	tx := MustTx(boil.BeginTx(ctx, nil))
	defer func() { _ = tx.Rollback() }()
	...
	if err = randomize.Struct(seed, &b, jokeDBTypes, false, jokeColumnsWithDefault...); err != nil {
		t.Fatal(err)
	}
	if err = randomize.Struct(seed, &c, jokeDBTypes, false, jokeColumnsWithDefault...); err != nil {
		t.Fatal(err)
	}
	...
	check, err := a.UserJokes().All(ctx, tx)
	if err != nil {
		t.Fatal(err)
	}
	...
	slice := UserSlice{&a}
	if err = a.L.LoadUserJokes(ctx, tx, false, (*[]*User)(&slice), nil); err != nil {
		t.Fatal(err)
	}
	if got := len(a.R.UserJokes); got != 2 {
		t.Error("number of eager loaded records wrong, got:", got)
	}

	a.R.UserJokes = nil
	if err = a.L.LoadUserJokes(ctx, tx, true, &a, nil); err != nil {
		t.Fatal(err)
	}
	if got := len(a.R.UserJokes); got != 2 {
		t.Error("number of eager loaded records wrong, got:", got)
...
func testUserToManyUserLikes(t *testing.T) {
	var err error
	ctx := context.Background()
	tx := MustTx(boil.BeginTx(ctx, nil))
	defer func() { _ = tx.Rollback() }()
	...
	check, err := a.UserLikes().All(ctx, tx)
	if err != nil {
		t.Fatal(err)
	}
	...
	slice := UserSlice{&a}
	if err = a.L.LoadUserLikes(ctx, tx, false, (*[]*User)(&slice), nil); err != nil {
		t.Fatal(err)
	}
	if got := len(a.R.UserLikes); got != 2 {
		t.Error("number of eager loaded records wrong, got:", got)
	}

	a.R.UserLikes = nil
	if err = a.L.LoadUserLikes(ctx, tx, true, &a, nil); err != nil {
		t.Fatal(err)
	}
	if got := len(a.R.UserLikes); got != 2 {
		t.Error("number of eager loaded records wrong, got:", got)
...
func testUserToManyCreatorRooms(t *testing.T) {
	var err error
	ctx := context.Background()
	tx := MustTx(boil.BeginTx(ctx, nil))
	defer func() { _ = tx.Rollback() }()
	...
	check, err := a.CreatorRooms().All(ctx, tx)
	if err != nil {
		t.Fatal(err)
	}
	...
	slice := UserSlice{&a}
	if err = a.L.LoadCreatorRooms(ctx, tx, false, (*[]*User)(&slice), nil); err != nil {
		t.Fatal(err)
	}
	if got := len(a.R.CreatorRooms); got != 2 {
		t.Error("number of eager loaded records wrong, got:", got)
	}

	a.R.CreatorRooms = nil
	if err = a.L.LoadCreatorRooms(ctx, tx, true, &a, nil); err != nil {
		t.Fatal(err)
	}
	if got := len(a.R.CreatorRooms); got != 2 {
		t.Error("number of eager loaded records wrong, got:", got)
...
func testUserToManyUserRoomMembers(t *testing.T) {
	var err error
	ctx := context.Background()
	tx := MustTx(boil.BeginTx(ctx, nil))
	defer func() { _ = tx.Rollback() }()
	...
	check, err := a.UserRoomMembers().All(ctx, tx)
	if err != nil {
		t.Fatal(err)
	}
	...
	slice := UserSlice{&a}
	if err = a.L.LoadUserRoomMembers(ctx, tx, false, (*[]*User)(&slice), nil); err != nil {
		t.Fatal(err)
	}
	if got := len(a.R.UserRoomMembers); got != 2 {
		t.Error("number of eager loaded records wrong, got:", got)
	}

	a.R.UserRoomMembers = nil
	if err = a.L.LoadUserRoomMembers(ctx, tx, true, &a, nil); err != nil {
		t.Fatal(err)
	}
	if got := len(a.R.UserRoomMembers); got != 2 {
		t.Error("number of eager loaded records wrong, got:", got)
...
func testUserToManyUserRoomMessages(t *testing.T) {
	var err error
	ctx := context.Background()
	tx := MustTx(boil.BeginTx(ctx, nil))
	defer func() { _ = tx.Rollback() }()
	...
	check, err := a.UserRoomMessages().All(ctx, tx)
	if err != nil {
		t.Fatal(err)
	}
	...
	slice := UserSlice{&a}
	if err = a.L.LoadUserRoomMessages(ctx, tx, false, (*[]*User)(&slice), nil); err != nil {
		t.Fatal(err)
	}
	if got := len(a.R.UserRoomMessages); got != 2 {
		t.Error("number of eager loaded records wrong, got:", got)
	}

	a.R.UserRoomMessages = nil
	if err = a.L.LoadUserRoomMessages(ctx, tx, true, &a, nil); err != nil {
		t.Fatal(err)
	}
	if got := len(a.R.UserRoomMessages); got != 2 {
		t.Error("number of eager loaded records wrong, got:", got)
...
func testUserToManyAddOpUserComments(t *testing.T) {
	var err error
	...
	for i, x := range foreignersSplitByInsertion {
		err = a.AddUserComments(ctx, tx, i != 0, x...)
		if err != nil {
			t.Fatal(err)
		}
		...
		if a.R.UserComments[i*2] != first {
			t.Error("relationship struct slice not set to correct value")
		}
		if a.R.UserComments[i*2+1] != second {
			t.Error("relationship struct slice not set to correct value")
		}

		count, err := a.UserComments().Count(ctx, tx)
		if err != nil {
			t.Fatal(err)
		}
...
func testUserToManyAddOpUserJokes(t *testing.T) {
	var err error
	...
	foreigners := []*Joke{&b, &c, &d, &e}
	for _, x := range foreigners {
		if err = randomize.Struct(seed, x, jokeDBTypes, false, strmangle.SetComplement(jokePrimaryKeyColumns, jokeColumnsWithoutDefault)...); err != nil {
			t.Fatal(err)
		}
	}
	...
	foreignersSplitByInsertion := [][]*Joke{
		{&b, &c},
		{&d, &e},
	}

	for i, x := range foreignersSplitByInsertion {
		err = a.AddUserJokes(ctx, tx, i != 0, x...)
		if err != nil {
			t.Fatal(err)
		}
		...
		if a.R.UserJokes[i*2] != first {
			t.Error("relationship struct slice not set to correct value")
		}
		if a.R.UserJokes[i*2+1] != second {
			t.Error("relationship struct slice not set to correct value")
		}

		count, err := a.UserJokes().Count(ctx, tx)
		if err != nil {
			t.Fatal(err)
		}
		if want := int64((i + 1) * 2); count != want {
...
func testUserToManyAddOpUserLikes(t *testing.T) {
	var err error
	...
	for i, x := range foreignersSplitByInsertion {
		err = a.AddUserLikes(ctx, tx, i != 0, x...)
		if err != nil {
			t.Fatal(err)
		}
		...
		if a.R.UserLikes[i*2] != first {
			t.Error("relationship struct slice not set to correct value")
		}
		if a.R.UserLikes[i*2+1] != second {
			t.Error("relationship struct slice not set to correct value")
		}

		count, err := a.UserLikes().Count(ctx, tx)
		if err != nil {
			t.Fatal(err)
		}
		if want := int64((i + 1) * 2); count != want {
...
func testUserToManyAddOpCreatorRooms(t *testing.T) {
	var err error
	...
	for i, x := range foreignersSplitByInsertion {
		err = a.AddCreatorRooms(ctx, tx, i != 0, x...)
		if err != nil {
			t.Fatal(err)
		}
		...
		if a.R.CreatorRooms[i*2] != first {
			t.Error("relationship struct slice not set to correct value")
		}
		if a.R.CreatorRooms[i*2+1] != second {
			t.Error("relationship struct slice not set to correct value")
		}

		count, err := a.CreatorRooms().Count(ctx, tx)
		if err != nil {
			t.Fatal(err)
		}
		if want := int64((i + 1) * 2); count != want {
...
func testUserToManyAddOpUserRoomMembers(t *testing.T) {
	var err error
	...
	for i, x := range foreignersSplitByInsertion {
		err = a.AddUserRoomMembers(ctx, tx, i != 0, x...)
		if err != nil {
			t.Fatal(err)
		}
		...
		if a.R.UserRoomMembers[i*2] != first {
			t.Error("relationship struct slice not set to correct value")
		}
		if a.R.UserRoomMembers[i*2+1] != second {
			t.Error("relationship struct slice not set to correct value")
		}

		count, err := a.UserRoomMembers().Count(ctx, tx)
		if err != nil {
			t.Fatal(err)
		}
		if want := int64((i + 1) * 2); count != want {
...
func testUserToManyAddOpUserRoomMessages(t *testing.T) {
	var err error
	...
	for i, x := range foreignersSplitByInsertion {
		err = a.AddUserRoomMessages(ctx, tx, i != 0, x...)
		if err != nil {
			t.Fatal(err)
		}
		...
		if a.R.UserRoomMessages[i*2] != first {
			t.Error("relationship struct slice not set to correct value")
		}
		if a.R.UserRoomMessages[i*2+1] != second {
			t.Error("relationship struct slice not set to correct value")
		}

		count, err := a.UserRoomMessages().Count(ctx, tx)
		if err != nil {
			t.Fatal(err)
		}
		if want := int64((i + 1) * 2); count != want {
...
var (
	userDBTypes = map[string]string{`ID`: `uuid`, `Username`: `character varying`, `Email`: `character varying`, `HashedPassword`: `character varying`, `Fullname`: `character varying`, `Status`: `character varying`, `CreatedAt`: `timestamp without time zone`}
	_           = bytes.MinRead
)
