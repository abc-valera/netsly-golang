...
var JokeTableColumns = struct {
	...
	Title:       "jokes.title",
	Text:        "jokes.text",
	Explanation: "jokes.explanation",
	CreatedAt:   "jokes.created_at",
	UpdatedAt:   "jokes.updated_at",
	DeletedAt:   "jokes.deleted_at",
	UserID:      "jokes.user_id",
}
...
var JokeWhere = struct {
	...
	ID:          whereHelperstring{field: "\"jokes\".\"id\""},
	Title:       whereHelperstring{field: "\"jokes\".\"title\""},
	Text:        whereHelperstring{field: "\"jokes\".\"text\""},
	Explanation: whereHelperstring{field: "\"jokes\".\"explanation\""},
	CreatedAt:   whereHelpertime_Time{field: "\"jokes\".\"created_at\""},
	UpdatedAt:   whereHelpertime_Time{field: "\"jokes\".\"updated_at\""},
	DeletedAt:   whereHelpertime_Time{field: "\"jokes\".\"deleted_at\""},
	UserID:      whereHelperstring{field: "\"jokes\".\"user_id\""},
}
...
func (r *jokeR) GetComments() CommentSlice {
	if r == nil {
		return nil
	}
	return r.Comments
...
func (r *jokeR) GetLikes() LikeSlice {
	if r == nil {
		return nil
	}
	return r.Likes
...
var (
	jokeAllColumns            = []string{"id", "title", "text", "explanation", "created_at", "updated_at", "deleted_at", "user_id"}
	jokeColumnsWithoutDefault = []string{"id", "title", "text", "explanation", "created_at", "updated_at", "deleted_at", "user_id"}
...
func (q jokeQuery) One(ctx context.Context, exec boil.ContextExecutor) (*Joke, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "sqlboiler: failed to execute a one query for jokes")
	}
...
func (q jokeQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "sqlboiler: failed to count jokes rows")
	}
...
func (q jokeQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "sqlboiler: failed to check if jokes exists")
	}
...
func (o *Joke) Comments(mods ...qm.QueryMod) commentQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"comments\".\"joke_id\"=?", o.ID),
	)
...
func (o *Joke) Likes(mods ...qm.QueryMod) likeQuery {
	var queryMods []qm.QueryMod
	if len(mods) != 0 {
		queryMods = append(queryMods, mods...)
	}
...
func (jokeL) LoadUser(ctx context.Context, e boil.ContextExecutor, singular bool, maybeJoke interface{}, mods queries.Applicator) error {
	...
	if singular {
		...
		foreign.R.Jokes = append(foreign.R.Jokes, object)
		return nil
	}
	...
	for _, local := range slice {
		for _, foreign := range resultSlice {
			if local.UserID == foreign.ID {
				...
				foreign.R.Jokes = append(foreign.R.Jokes, local)
				break
			}
		}
	}
...
func (jokeL) LoadComments(ctx context.Context, e boil.ContextExecutor, singular bool, maybeJoke interface{}, mods queries.Applicator) error {
	var slice []*Joke
	var object *Joke
	...
	query := NewQuery(
		qm.From(`comments`),
		qm.WhereIn(`comments.joke_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (jokeL) LoadLikes(ctx context.Context, e boil.ContextExecutor, singular bool, maybeJoke interface{}, mods queries.Applicator) error {
	var slice []*Joke
	var object *Joke
...
func (o *Joke) SetUser(ctx context.Context, exec boil.ContextExecutor, insert bool, related *User) error {
	...
	if related.R == nil {
		...
		related.R.Jokes = append(related.R.Jokes, o)
	}
...
// Uses the global database handle.
func (o *Joke) AddCommentsG(ctx context.Context, insert bool, related ...*Comment) error {
...
// Appends related to o.R.Comments.
// Sets related.R.Joke appropriately.
func (o *Joke) AddComments(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Comment) error {
	var err error
	for _, rel := range related {
		if insert {
			...
			updateQuery := fmt.Sprintf(
				...
				strmangle.SetParamNames("\"", "\"", 0, []string{"joke_id"}),
...
// Sets related.R.Joke appropriately.
// Uses the global database handle.
func (o *Joke) AddLikesG(ctx context.Context, insert bool, related ...*Like) error {
...
// Appends related to o.R.Likes.
// Sets related.R.Joke appropriately.
func (o *Joke) AddLikes(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Like) error {
	var err error
	for _, rel := range related {
		if insert {
			rel.JokeID = o.ID
...
func Jokes(mods ...qm.QueryMod) jokeQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"\"jokes\".*"})
	}
...
func FindJoke(ctx context.Context, exec boil.ContextExecutor, iD string, selectCols ...string) (*Joke, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "sqlboiler: unable to select from jokes")
	}
...
func (o *Joke) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("sqlboiler: no jokes provided for insertion")
	}
	...
	if !cached {
		...
		if len(wl) != 0 {
			...
			cache.query = "INSERT INTO \"jokes\" %sDEFAULT VALUES%s"
		}
	...
	if err != nil {
		return errors.Wrap(err, "sqlboiler: unable to insert into jokes")
	}
...
func (o *Joke) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("sqlboiler: unable to update jokes, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "sqlboiler: unable to update jokes row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "sqlboiler: failed to get rows affected by update for jokes")
	}
...
func (q jokeQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "sqlboiler: unable to update all for jokes")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "sqlboiler: unable to retrieve rows affected for jokes")
	}
...
func (o *Joke) UpsertG(ctx context.Context, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	return o.Upsert(ctx, boil.GetContextDB(), updateOnConflict, conflictColumns, updateColumns, insertColumns)
}

// Upsert attempts an insert using an executor, and does an update or ignore on conflict.
// See boil.Columns documentation for how to properly use updateColumns and insertColumns.
func (o *Joke) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("sqlboiler: no jokes provided for upsert")
	}
	if !boil.TimestampsAreSkipped(ctx) {
		currTime := time.Now().In(boil.GetLocation())
	...
	if !cached {
		...
		if updateOnConflict && len(update) == 0 {
			return errors.New("sqlboiler: unable to upsert jokes, could not build update column list")
		}
		...
		cache.query = buildUpsertQuerySQLite(dialect, "\"jokes\"", updateOnConflict, ret, update, conflict, insert)
	...
	if err != nil {
		return errors.Wrap(err, "sqlboiler: unable to upsert jokes")
	}
...
func (o *Joke) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "sqlboiler: unable to delete from jokes")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "sqlboiler: failed to get rows affected by delete for jokes")
	}
...
func (q jokeQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "sqlboiler: unable to delete all from jokes")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "sqlboiler: failed to get rows affected by deleteall for jokes")
	}
...
func JokeExists(ctx context.Context, exec boil.ContextExecutor, iD string) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "sqlboiler: unable to check if jokes exists")
	}
